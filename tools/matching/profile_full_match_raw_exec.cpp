#include "core/execution_sink.hpp"
#include "matching/fixed_clob.hpp"
...
int main() {
    ...
    ExecutionBuffer exec_buffer;
    exec_buffer.reserve(n);
    ...
    for (std::size_t i = 0; i < n; ++i) {
        ...
        bool ok = book.submit_limit_order(buy_id, Side::Buy, price, qty, exec_buffer);
    ...
    std::cout << "executions=" << exec_buffer.size() << "\n";
